package com.br.aula.aula02.entities.resource.execeptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> ResourceNotFount(ResourceNotFountException e, HttpServletRequest request ){
